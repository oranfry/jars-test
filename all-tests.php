...
do_change_and_test('100-corrupt-index', 'check-albums-and-artists');

do_change_and_test('110-wait-for-version', 'check-albums-and-artists');
do_change_and_test('111-version-timeout', 'check-albums-and-artists');
